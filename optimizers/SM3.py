...
class SM3(Optimizer):
    ...
    """
    def __init__(self, params, lr=0.1, weight_decay=0.0, momentum=0.0, beta=0.0, eps=1e-30):
        if not 0.0 <= lr:
        ...
        defaults = {'lr': lr, 'weight_decay': weight_decay, 'momentum': momentum, 'beta': beta, 'eps': eps}
