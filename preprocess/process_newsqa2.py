from preprocess_tools.NewsQAProcessor import process
...
for data_split in ["train", "dev", "test"]:
    para_filename = fspath(Path("../data/newsqa/para-{}.txt".format(data_split)))
    src_filename = fspath(Path("../data/newsqa/src-{}.txt".format(data_split)))
    tgt_filename = fspath(Path("../data/newsqa/tgt-{}.txt".format(data_split)))
    raw_filename = fspath(Path("../data/newsqa/combined-newsqa-data-v1.json"))
    ...
    save_one2one_sentence_QG_path = fspath(
        Path("../processed_data/NewsQA_one2one_sentence_QG_{}{}.jsonl".format(data_split, key)))
    save_one2many_sentence_QG_path = fspath(
        Path("../processed_data/NewsQA_one2many_sentence_QG_{}{}.jsonl".format(data_split, key)))
    save_one2one_QG_path = fspath(
        Path("../processed_data/NewsQA_one2one_QG_{}{}.jsonl".format(data_split, key)))
    save_one2many_QG_path = fspath(
        Path("../processed_data/NewsQA_one2many_QG_{}{}.jsonl".format(data_split, key)))
    save_one2one_sentence_type_driven_QG_path = fspath(
        Path("../processed_data/NewsQA_one2one_sentence_type_driven_QG_{}{}.jsonl".format(
            data_split, key)))
    save_one2many_sentence_type_driven_QG_path = fspath(
        Path("../processed_data/NewsQA_one2many_sentence_type_driven_QG_{}{}.jsonl".format(
            data_split, key)))
    save_qw_classification_path = fspath(
        Path("../processed_data/NewsQA_qw_{}{}.jsonl".format(data_split, key)))
    save_qw_hierarchical_labeling_path = fspath(
        Path("../processed_data/NewsQA_qw_hierarchical_labeling_{}{}.jsonl".format(data_split, key)))
    save_qt_classification_path = fspath(
        Path("../processed_data/NewsQA_qt_{}{}.jsonl".format(data_split, key)))

    save_one2one_sentence_QG_metadata_path = fspath(
        Path("../processed_data/NewsQA_one2one_sentence_QG_metadata.pkl"))
    save_one2many_sentence_QG_metadata_path = fspath(
        Path("../processed_data/NewsQA_one2many_sentence_QG_metadata.pkl"))
    save_one2one_QG_metadata_path = fspath(
        Path("../processed_data/NewsQA_one2one_QG_metadata.pkl"))
    save_one2many_QG_metadata_path = fspath(
        Path("../processed_data/NewsQA_one2many_QG_metadata.pkl"))
    save_one2one_sentence_type_driven_QG_metadata_path = fspath(
        Path("../processed_data/NewsQA_one2one_sentence_type_driven_QG_metadata.pkl"))
    save_one2many_sentence_type_driven_QG_metadata_path = fspath(
        Path("../processed_data/NewsQA_one2many_sentence_type_driven_QG_metadata.pkl"))
    save_qw_classification_metadata_path = fspath(
        Path("../processed_data/NewsQA_qw_metadata.pkl"))
    save_qw_hierarchical_labeling_metadata_path = fspath(
        Path("../processed_data/NewsQA_qw_hierarchical_labeling_metadata.pkl"))
    save_qt_classification_metadata_path = fspath(
        Path("../processed_data/NewsQA_qt_metadata.pkl"))
