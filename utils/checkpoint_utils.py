...
def load_temp_checkpoint(agent, time, checkpoint_paths, args, log_paths):
    ...
    if args.checkpoint:
        ...
        loaded_stuff["current_iter"] = checkpoint["current_iter"]
        loaded_stuff["train_metrics"] = checkpoint["train_metrics"]
...
def save_infer_checkpoint(agent, checkpoint_paths, log_paths):
    T.save({
